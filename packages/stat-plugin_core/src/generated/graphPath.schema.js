...
exports.graphPathSchema = void 0;
/**
 * =============================================================================
 * graphPathSchema: ShexJ Schema for graphPath
 * =============================================================================
 */
exports.graphPathSchema = {
    type: "Schema",
    start: "https://oxfordia.setmeld.com/statistics#GraphPathShape",
    shapes: [
        {
                ...
                expression: {
                    ...
                    expressions: [
                        ...
                        },
                        {
                            ...
                            valueExpr: "https://oxfordia.setmeld.com/statistics#GraphNodeFilterShape",
                        },
                        {
                            type: "TripleConstraint",
                            predicate: "https://oxfordia.setmeld.com/statistics#steps",
                            valueExpr: "https://oxfordia.setmeld.com/statistics#GraphTraversalStepShape",
                            min: 0,
                            max: -1,
                        },
                        {
                            ...
                            valueExpr: "https://oxfordia.setmeld.com/statistics#GraphValueSelectorShape",
                            min: 0,
                            max: 1,
                        },
                    ],
                ...
                expression: {
                    ...
                    expressions: [
                        ...
                        },
                        {
                            ...
                            valueExpr: "https://oxfordia.setmeld.com/statistics#GraphPredicateFilterShape",
                            min: 0,
                            max: -1,
                        },
                    ],
                ...
                expression: {
                    ...
                    expressions: [
                        ...
                        },
                        {
                            ...
                            valueExpr: "https://oxfordia.setmeld.com/statistics#GraphLiteralFilterShape",
                        },
                    ],
                },
            },
...
//# sourceMappingURL=graphPath.schema.js.map